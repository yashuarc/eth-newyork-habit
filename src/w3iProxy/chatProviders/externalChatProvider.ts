...
export default class ExternalChatProvider implements W3iChatProvider {
  ...
  protected async postToExternalProvider<
    MName extends keyof ChatClientFunctions
  >(methodName: MName, ...params: Parameters<ChatClientFunctions[MName]>) {
    return this.communicator.postToExternalProvider<
      ReturnType<ChatClientFunctions[MName]>
    >(methodName, params[0], "chat");
  }
