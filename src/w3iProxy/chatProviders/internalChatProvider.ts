...
export default class InternalChatProvider implements W3iChatProvider {
  ...
  public async getSentInvites(params?: { account: string }) {
    ...
    return Promise.resolve(
      this.chatClient.getSentInvites(
        params ?? { account: this.getRequiredInternalAddress() }
      )
    );
  }
  ...
  public async getReceivedInvites(params?: { account: string }) {
    ...
    return Promise.resolve(
      this.chatClient.getReceivedInvites(
        params ?? { account: this.getRequiredInternalAddress() }
      )
    );
  }
  ...
  public async invite(params: ChatClientTypes.Invite) {
    ...
    } else return this.chatClient.invite(params);
  }
  ...
  public async register(params: {
    ...
    try {
       ...
       */
      return this.chatClient.identityKeys.getIdentity({
  ...
  public async getMutedContacts() {
    return Promise.resolve(
      this.mutedContacts.getAll().map((params) => params.topic)
    );
  }
}
