...
export default class ExternalPushProvider implements W3iPushProvider {
  ...
  protected async postToExternalProvider<
    MName extends keyof PushClientFunctions
  >(methodName: MName, ...params: Parameters<PushClientFunctions[MName]>) {
    return this.communicator.postToExternalProvider<
      ReturnType<PushClientFunctions[MName]>
    >(methodName, params[0], "notify");
  }
